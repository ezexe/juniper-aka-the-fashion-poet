...
namespace Juniper.WinUI.App.Controls
{
    ...
    public sealed partial class TitledFieldsUserControl : UserControl
    {
        public static readonly DependencyProperty HeaderTextProperty = DependencyProperty.Register("HeaderText", typeof(string), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty FieldsProperty = DependencyProperty.Register("Fields", typeof(object), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        public object Fields
        {
            get { return GetValue(FieldsProperty); }
            set { SetValue(FieldsProperty, value); }
        }

        public static readonly DependencyProperty OutputProperty = DependencyProperty.Register("Output", typeof(object), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty OptionsProperty = DependencyProperty.Register("Options", typeof(object), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty XamlProperty = DependencyProperty.Register("Xaml", typeof(string), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        public string Xaml
        {
        ...
        public static readonly DependencyProperty XamlSourceProperty = DependencyProperty.Register("XamlSource", typeof(object), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CSharpProperty = DependencyProperty.Register("CSharp", typeof(string), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CSharpSourceProperty = DependencyProperty.Register("CSharpSource", typeof(object), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty SubstitutionsProperty = DependencyProperty.Register("Substitutions", typeof(IList<ControlExampleSubstitution>), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ExampleHeightProperty = DependencyProperty.Register("ExampleHeight", typeof(GridLength), typeof(TitledFieldsUserControl), new PropertyMetadata(new GridLength(1, GridUnitType.Star)));
        ...
        public static readonly DependencyProperty WebViewHeightProperty = DependencyProperty.Register("WebViewHeight", typeof(int), typeof(TitledFieldsUserControl), new PropertyMetadata(400));
        ...
        public static readonly DependencyProperty WebViewWidthProperty = DependencyProperty.Register("WebViewWidth", typeof(int), typeof(TitledFieldsUserControl), new PropertyMetadata(800));
        ...
        public new static readonly DependencyProperty HorizontalContentAlignmentProperty = DependencyProperty.Register("HorizontalContentAlignment", typeof(HorizontalAlignment), typeof(TitledFieldsUserControl), new PropertyMetadata(HorizontalAlignment.Left));
        ...
        public static readonly DependencyProperty MinimumUniversalAPIContractProperty = DependencyProperty.Register("MinimumUniversalAPIContract", typeof(int), typeof(TitledFieldsUserControl), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ErrorTextTextProperty = DependencyProperty.Register("ErrorText", typeof(string), typeof(TitledFieldsUserControl), new PropertyMetadata(null, new PropertyChangedCallback(OnErrorTextChanged)));

        public string ErrorText
        {
            get { return (string)GetValue(ErrorTextTextProperty); }
            set { SetValue(ErrorTextTextProperty, value); }
        }
        public TitledFieldsUserControl()
        {
        ...
        private void ControlPaddingBox_KeyUp(object sender, KeyRoutedEventArgs e)
        {
        ...
        {
            if (e.NewValue.ToString().IsNullEmptyOrWhiteSpace())
                ((TitledFieldsUserControl)d).tbErrorText.Visibility = Visibility.Collapsed;
            else
            {
                ((TitledFieldsUserControl)d).tbErrorText.Visibility = Visibility.Visible;
                ((TitledFieldsUserControl)d).tbErrorText.Text = e.NewValue.ToString();
            }
        }
